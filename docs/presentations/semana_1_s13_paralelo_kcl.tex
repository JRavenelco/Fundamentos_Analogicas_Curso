...
% ---------------------------------------------------------------------
\begin{frame}{Resultados LTspice · Corrientes (del Error Log)}
  \begin{table}
    \small
    \begin{tabular}{lcl}
      \toprule
...
% ---------------------------------------------------------------------
\begin{frame}{Resultado de la simulación · Gráfica}
  \begin{center}
    \includegraphics[width=0.86\textwidth]{figs/s13_kcl_balance.png}
  \end{center}
  \begin{itemize}
    \item \textbf{KCL:} las barras de rama suman $I_{fuente}$ (línea discontinua).
    \item \textbf{Balance:} las potencias de rama suman $P_{fuente}$.
    \item La rama de menor resistencia ($R_1$) lleva \textbf{más} corriente y disipa más.
  \end{itemize}
\end{frame}
