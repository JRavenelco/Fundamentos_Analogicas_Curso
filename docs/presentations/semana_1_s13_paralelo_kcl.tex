    ...
    \begin{column}{0.52\textwidth}
      \begin{circuitikz}[american voltages, scale=0.75]
        \draw (0,3) to[V, l_=$12\,\mathrm{V}$] (0,0)
          to[R, l={$R_s=3\,\Omega$}] (3,3) -- (6.4,3);
        \draw (0,0) -- (6.4,0);
        \draw (3.8,3) to[R, l={$R_H=6\,\Omega$}, i>^={$I_H$}] (3.8,0);
        \draw (6.0,3) to[R, l={$R_M=3\,\mathrm{M}\Omega$}, i>^={$I_M$}] (6.0,0);
        \node[ground] at (0,0) {};
      \end{circuitikz}
    \end{column}
    ...
    \begin{column}{0.52\textwidth}
      \begin{circuitikz}[american currents, scale=0.75]
        \draw (0,0) to[I, l_=$6\,\mathrm{A}$] (0,3)
          to[R, l={$R_s=2\,\Omega$}] (3,3) -- (6.4,3);
        \draw (0,0) -- (6.4,0);
        \draw (3.8,3) to[R, l={$R_A=6\,\Omega$}, i>^={$I_A$}] (3.8,0);
        \draw (6.0,3) to[R, l={$R_B=3\,\Omega$}, i>^={$I_B$}] (6.0,0);
        \node[ground] at (0,0) {};
      \end{circuitikz}
    \end{column}
    \begin{column}{0.44\textwidth}
